                                            ...
                                            <div class="form-row">
                                                            ...
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_1" value="3" 
                                                                        <?php if ($scoresByQuestionId[1] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_1" value="0" 
                                                                        <?php if ($scoresByQuestionId[1] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_1" value="N/A" 
                                                                        <?php if ($scoresByQuestionId[1] == 'N/A') echo 'checked="checked"'; ?>  onchange="updateScores()"> N/A
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <?php if($questionNumber == 2){ ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_2" value="2" <?php if ($scoresByQuestionId[2] == '2') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_2" value="0" <?php if ($scoresByQuestionId[2] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_2" value="N/A" <?php if ($scoresByQuestionId[2] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                    </div>
                                                        <!-- Right side: score input -->
                                                ...
                                                <?php if($questionNumber == 3){ ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_3" value="3" <?php if ($scoresByQuestionId[3] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_3" value="0" <?php if ($scoresByQuestionId[3] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_3" value="N/A" <?php if ($scoresByQuestionId[3] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                        <div >
                                                ...
                                                <?php if($questionNumber == 4){ ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_4" value="3" <?php if ($scoresByQuestionId[4] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_4" value="0" <?php if ($scoresByQuestionId[4] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_4" value="N/A" <?php if ($scoresByQuestionId[4] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                        <div >
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_5" value="3"
                                                                            <?php if ($scoresByQuestionId[5] == '3') echo 'checked="checked"'; ?>
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_5" value="0"
                                                                            <?php if ($scoresByQuestionId[5] == '0') echo 'checked="checked"'; ?>
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_5" value="N/A"
                                                                            <?php if ($scoresByQuestionId[5] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                                    </label>
                                                                </div>
                                                ...
                                                <?php if($questionNumber == 6){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_6" value="3" <?php if ($scoresByQuestionId[6] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_6" value="0" <?php if ($scoresByQuestionId[6] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_6" value="N/A" <?php if ($scoresByQuestionId[6] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <!-- Right side: score input -->
                                                ...
                                                <?php if($questionNumber == 7){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_7" value="5" <?php if ($scoresByQuestionId[7] == '5') echo 'checked="checked"'; ?> onchange="updateScores()" > Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_7" value="0" <?php if ($scoresByQuestionId[7] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_7" value="N/A" <?php if ($scoresByQuestionId[7] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                    </div>
                                                ...
                                                <?php if($questionNumber == 8){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_8" value="5" <?php if ($scoresByQuestionId[8] == '5') echo 'checked="checked"'; ?> onchange="updateScores()" > Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_8" value="0" <?php if ($scoresByQuestionId[8] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_8" value="N/A" <?php if ($scoresByQuestionId[8] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                    </div>
                                                ...
                                                <?php if($questionNumber == 9){ ?>
                                                    <input type="hidden" name="question_9" value="<?= $value->qa_question_id ?>">
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_9" value="10" <?php if ($scoresByQuestionId[9] == '10') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_9" value="0" <?php if ($scoresByQuestionId[9] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-2 form-check form-check-inline">
                                                                <label class="ms-4">
                                                                    <input type="radio" name="answer_9" value="N/A" <?php if ($scoresByQuestionId[9] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                                </label>
                                                            </div>
                                                            <!-- Right side: score input -->
                                                            <div>
                                                ...
                                                <?php if($questionNumber == 10){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_10" value="3" <?php if ($scoresByQuestionId[10] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_10" value="0" <?php if ($scoresByQuestionId[10] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_10" value="N/A" <?php if ($scoresByQuestionId[10] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                        <div>
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_11" value="15"
                                                                            <?php if ($scoresByQuestionId[11] == '15') echo 'checked="checked"'; ?>
                                                                            onchange="updateScores()"> Yes
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_11" value="0"
                                                                            <?php if ($scoresByQuestionId[11] == '0') echo 'checked="checked"'; ?>
                                                                            onchange="updateScores()"> No
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_11" value="N/A"
                                                                            <?php if ($scoresByQuestionId[11] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                                    </label>
                                                                </div>
                                                ...
                                                <?php if($questionNumber == 12){ ?>
                                                    ...
                                                    <!-- Flex container -->
                                                     <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_12" value="15" <?php if ($scoresByQuestionId[12] == '15') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes                                        
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_12" value="0" <?php if ($scoresByQuestionId[12] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No                                      
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_12" value="N/A" <?php if ($scoresByQuestionId[12] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" >N/A                                   
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                    </div>
                                                ...
                                                <?php if($questionNumber == 13){ ?>
                                                    ...
                                                    <!-- Flex container -->
                                                     <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_13" value="3" <?php if ($scoresByQuestionId[13] == '3') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_13" value="0" <?php if ($scoresByQuestionId[13] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_13" value="N/A" <?php if ($scoresByQuestionId[13] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"  > N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                        <div>
                                                ...
                                                <?php if($questionNumber == 14){ ?>
                                                    ...
                                                    <!-- Flex container -->
                                                     <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_14" value="15" <?php if ($scoresByQuestionId[14] == '15') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes                               
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_14" value="0" <?php if ($scoresByQuestionId[14] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No                               
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_14" value="N/A" <?php if ($scoresByQuestionId[14] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" >N/A
                                                            </label>
                                                        </div>
                                                        <!-- Right side: score input -->
                                                    </div>
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_15" value="2" 
                                                                            <?php if ($scoresByQuestionId[15] == '2') echo 'checked="checked"'; ?> 
                                                                            onchange="updateScores()"> Yes
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_15" value="0" 
                                                                            <?php if ($scoresByQuestionId[15] == '0') echo 'checked="checked"'; ?> 
                                                                            onchange="updateScores()"> No
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_15" value="N/A" 
                                                                            <?php if ($scoresByQuestionId[15] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_16" value="2" 
                                                                            <?php if ($scoresByQuestionId[16] == '2') echo 'checked="checked"'; ?> 
                                                                            onchange="updateScores()"> Yes
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_16" value="0" 
                                                                            <?php if ($scoresByQuestionId[16] == '0') echo 'checked="checked"'; ?> 
                                                                            onchange="updateScores()"> No
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-2 form-check form-check-inline">
                                                                    <label class="ms-4">
                                                                        <input type="radio" name="answer_16" value="N/A" 
                                                                            <?php if ($scoresByQuestionId[16] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()" > N/A
                                                                    </label>
                                                                </div>
                                                                <!-- Right side: hidden score input -->
                                                                <div>
                                                ...
                                                <?php if($questionNumber == 17){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_17" value="4" <?php if ($scoresByQuestionId[17] == '4') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_17" value="0" <?php if ($scoresByQuestionId[17] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_17" value="N/A" <?php if ($scoresByQuestionId[17] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"> N/A
                                                            </label>
                                                        </div>
                                                    </div>
                                                        <!-- Right side: score input -->
                                                ...
                                                <?php if($questionNumber == 18){ ?>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_18" value="4" <?php if ($scoresByQuestionId[18] == '4') echo 'checked="checked"'; ?> onchange="updateScores()"> Yes
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_18" value="0" <?php if ($scoresByQuestionId[18] == '0') echo 'checked="checked"'; ?> onchange="updateScores()"> No
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-2 form-check form-check-inline">
                                                            <label class="ms-4">
                                                                <input type="radio" name="answer_18" value="N/A" <?php if ($scoresByQuestionId[18] == 'N/A') echo 'checked="checked"'; ?> onchange="updateScores()"> N/A
                                                            </label>
                                                        </div>
                                                    </div>
                                                        <!-- Right side: score input -->
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control form-control-solid"
                                                        ...
                                                        style="border-color: black;"><?php if(!empty($qa_result)){ echo $qa_result[0]->qa_comment;} ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            ...
                                            <input type="submit" name="Update_QA" value="Update QA Lead"  class="btn btn-primary float-end mt-5 mb-3">
                                    </div>
                                </div>
                            <?php echo form_close();?>
                        </div>
