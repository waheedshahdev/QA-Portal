...
<body style="background-image: url('<?php echo base_url(); ?>adminfiles/assets/img/clientportal.png'); background-size: cover;">
        <!-- LOGIN FORM -->
        <!--===================================================-->
        <div class="lock-wrapper">
          ...
          ?>
                            <form role="form" action="<?php echo base_url(); ?>admin/check_auth" method="post">
                                ...
                                <button type="submit" name="submit" value="Log In" class="btn btn btn-success pull-right">
                                    Log In
                                </button>
                            </form>
