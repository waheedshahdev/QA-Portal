          ...
          ?>
            <?php foreach ($data_found as $data) {
                # code...
                                        ...
                                        <form class="form-horizontal form-bordered" action="<?php echo base_url('admin/edit_lead/'.$this->uri->segment(3).''); ?>" method="post" id="registrationForm">
                                            <!-- Wizard Container 1 -->
                                            <div class="wizard-container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label"> Agent Name : </label>
                                                        ...
                                                        <select name="employee_id" class="form-control" data-parsley-group="payment" data-parsley-required required="">
                                                                <?php
                                                            if (isset($data->username)) {echo "<option value=".$data->employee_id." selected>".$data->username."</option>";}
                                                                           
                                                            ?>
                                                                <option value=""> Please Select One</option>
                                                                <?php foreach ($employees as $employee):?>
                                                                <option value="<?php echo $employee->ein ?>"><?php echo $employee->username; ?></option>
                                                            <?php endforeach; ?>
                                                            </select>
                                                    </div>
                                            ...
                                            <div class="wizard-container">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="client" class="form-control client_lo" data-parsley-group="payment" data-parsley-required id="client" >
																...
																echo '<option value="'.$data->client.'">'.$data->client.'</option>';
															} ?>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="disposition" class="form-control" data-parsley-group="payment" data-parsley-required required="">
                                                            	<?php if(isset($data->disposition)){
																echo '<option value="'.$data->disposition.'">'.$data->disposition.'</option>';
																} ?>
                                                    ...
                                                    <input type="text" style="display: none;" name="disp_id" value="<?php echo $data->disp_id; ?>">
